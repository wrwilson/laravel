    ...
    <div role="navigation" class="navbar header no-margin">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="index.html" class="navbar-brand"><img src="assets/img/logo.png" alt="Metronic Shop UI"></a><!-- LOGO -->
            </div>
            ...
            <div class="collapse navbar-collapse mega-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="product-list.html">Phone &amp; Broadband</a></li>
                    <li class="dropdown">
                      <a class="dropdown-toggle" data-toggle="dropdown" data-delay="0" data-close-others="false" data-target="product-list.html" href="product-list.html">
                        TV &amp; Broadband
                        <i class="fa fa-angle-down"></i>
                    ...
                    <li><a href="product-list.html">Business Broadband</a></li>  
                    <li><a href="product-list.html">Mobile Phone</a></li>              
                    <!-- END TOP SEARCH -->
                </ul>
            </div>
            <!-- END NAVIGATION -->
    ...
    <div class="page-slider margin-bottom-35">
      ...
      <div id="layerslider" style="width: 100%; height: 494px; margin: 0 auto;">
          ...
          <div class="ls-layer ls-layer2" style="slidedirection: right; transition2d: 110,111,112,113;">
            <img src="assets/temp/sliders/slide2/bg3.jpg" class="ls-bg" alt="Slide background">
