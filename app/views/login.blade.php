...
<link rel="stylesheet" type="text/css" href="{{ URL::asset ('admin_assets/plugins/select2/select2.css') }}"/>
<link rel="stylesheet" type="text/css" href="{{ URL::asset ('admin_assets/plugins/select2/select2-metronic.css') }}"/>
...
<link href="{{ URL::asset ('admin_assets/css/pages/login.css') }}" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html">
		<img src="{{ URL::asset ('admin_assets/img/logo-big.png') }}" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
	...
	<?= Form::open() ?>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" value="{{ Input::old('password') }}" />
			</div>
		</div>
...
<script src="{{ URL::asset ('admin_assets/plugins/jquery-validation/dist/jquery.validate.min.js') }}" type="text/javascript"></script>
<script type="text/javascript" src="{{ URL::asset ('admin_assets/plugins/select2/select2.min.js') }}"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="{{ URL::asset ('admin_assets/scripts/core/app.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset ('admin_assets/scripts/custom/login.js') }}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
